        ...
        public student_result GetStudentsResultDetail(int student_id,int quiz_id)
        {
            ...
            using (var repo = DataContextHelper.GetPPContextHelper())
            {
                try
                {
                    ...
                    var ppSql = PetaPoco.Sql.Builder.Select(@"top 1 quiz_q.quiz_id , std.student_id,isnull(quiz.passing_marks,50) as passing_marks,
                        ...
                        .InnerJoin("quiz_questions AS quiz_q").On("sa.question_id = quiz_q.question_id ")
                         .InnerJoin("students AS std").On("sa.student_id = std.student_id ")
                          ...
                          .GroupBy("quiz_q.quiz_id, std.student_id,  quiz.passing_marks")
